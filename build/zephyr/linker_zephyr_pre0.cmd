 ...
 *(.rela.*)
 ...
 rtio_area : ALIGN_WITH_INPUT { _rtio_list_start = .; KEEP(*(SORT_BY_NAME(._rtio.static.*))); _rtio_list_end = .;; } > dram0_0_seg AT > FLASH
 rtio_pool_area : ALIGN_WITH_INPUT { _rtio_pool_list_start = .; KEEP(*(SORT_BY_NAME(._rtio_pool.static.*))); _rtio_pool_list_end = .;; } > dram0_0_seg AT > FLASH
 rtio_iodev_area : ALIGN_WITH_INPUT { _rtio_iodev_list_start = .; KEEP(*(SORT_BY_NAME(._rtio_iodev.static.*))); _rtio_iodev_list_end = .;; } > dram0_0_seg AT > FLASH
 rtio_sqe_pool_area : ALIGN_WITH_INPUT { _rtio_sqe_pool_list_start = .; KEEP(*(SORT_BY_NAME(._rtio_sqe_pool.static.*))); _rtio_sqe_pool_list_end = .;; } > dram0_0_seg AT > FLASH
 rtio_cqe_pool_area : ALIGN_WITH_INPUT { _rtio_cqe_pool_list_start = .; KEEP(*(SORT_BY_NAME(._rtio_cqe_pool.static.*))); _rtio_cqe_pool_list_end = .;; } > dram0_0_seg AT > FLASH
...
biometric_driver_api_area : ALIGN_WITH_INPUT { _biometric_driver_api_list_start = .; KEEP(*(SORT_BY_NAME(._biometric_driver_api.static.*))); _biometric_driver_api_list_end = .;; } > drom0_0_seg AT > FLASH
...
otp_driver_api_area : ALIGN_WITH_INPUT { _otp_driver_api_list_start = .; KEEP(*(SORT_BY_NAME(._otp_driver_api.static.*))); _otp_driver_api_list_end = .;; } > drom0_0_seg AT > FLASH
...
uaol_driver_api_area : ALIGN_WITH_INPUT { _uaol_driver_api_list_start = .; KEEP(*(SORT_BY_NAME(._uaol_driver_api.static.*))); _uaol_driver_api_list_end = .;; } > drom0_0_seg AT > FLASH
...
wuc_driver_api_area : ALIGN_WITH_INPUT { _wuc_driver_api_list_start = .; KEEP(*(SORT_BY_NAME(._wuc_driver_api.static.*))); _wuc_driver_api_list_end = .;; } > drom0_0_seg AT > FLASH
...
stepper_ctrl_driver_api_area : ALIGN_WITH_INPUT { _stepper_ctrl_driver_api_list_start = .; KEEP(*(SORT_BY_NAME(._stepper_ctrl_driver_api.static.*))); _stepper_ctrl_driver_api_list_end = .;; } > drom0_0_seg AT > FLASH
...
ztest : ALIGN_WITH_INPUT
{
 ...
 bt_conn_cb_area : ALIGN_WITH_INPUT { _bt_conn_cb_list_start = .; KEEP(*(SORT_BY_NAME(._bt_conn_cb.static.*))); _bt_conn_cb_list_end = .;; } > drom0_0_seg AT > FLASH
 ...
 sensor_decoder_api_area : ALIGN_WITH_INPUT { _sensor_decoder_api_list_start = .; KEEP(*(SORT_BY_NAME(._sensor_decoder_api.static.*))); _sensor_decoder_api_list_end = .;; } > drom0_0_seg AT > FLASH
