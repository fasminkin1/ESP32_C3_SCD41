...
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_k_object_access_check;
...
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_rtio_pool_acquire;
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_rtio_pool_release;
...
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_rtio_sqe_signal;
